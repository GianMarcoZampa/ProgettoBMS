...
Q_selector = 'test_11';
identical_cell_selector = 1; % 0 celle diverse, 1= celle identiche alla 5.
...
% N.B. i dati saranno disposti in colonne, dove il primo segnale è quello del multiplexer nel blocco "To workspace".
